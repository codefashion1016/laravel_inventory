...
class OffinventorysImport implements ToCollection
{
    /**
    ...
    public function collection(Collection $rows)
    {
        ...
        $existingPartNumbers = Offinventorys::whereIn('wompart_num', $rows->pluck(2))->pluck('wompart_num')->toArray();
