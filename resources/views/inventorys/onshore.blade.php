        ...
        <div class="page-heading">
            <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h1>WOM Onshore Management System</h1>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('inventorytype') }}">Inventory Type</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Onshore Inventory</li>
                            </ol>
                        </nav>
                    </div>
            </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('inventory') }}">Inventory</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('partsearch') }}">Part Search</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
