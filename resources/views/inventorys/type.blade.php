                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('inventorydrs') }}">DRS</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Inventory Type</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('inventoryonshore') }}">Onshore Inventory</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('inventoryoffshore') }}">Offshore Inventory</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
