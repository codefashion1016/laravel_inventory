    ...
    <div class="page-heading">
        ...
        <div class="col-lg-12 col-12">
            <div id="auth-left">
                ...
                <form method="POST" action="{{ route('inventory/save') }}" class="md-float-material" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-lg " name="wom_po" value="{{ old('wom_po') }}" placeholder="Order Number">
                        <div class="form-control-icon">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-lg" name="durometer" placeholder="Durometer">
                        <div class="form-control-icon">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-lg" name="where_used" placeholder="Where used">
                        <div class="form-control-icon">
        ...
        <div class="col-lg-12 col-12">
            <div id="auth-left">
                ...
                <form method="POST" action="{{ route('inventory/save') }}" class="md-float-material" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="number" class="form-control form-control-lg" name="quantity" value="{{ old('quantity') }}" placeholder="Enter Quantity" min="0">
                        <div class="form-control-icon">
                            <i class="bi bi-cash"></i>
                        </div>
                    </div>
