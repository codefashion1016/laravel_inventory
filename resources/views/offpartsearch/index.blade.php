                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('inventoryoffshore') }}">Back</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <form action="{{ route('filter_offinventory') }}" method="GET">
                        ...
                        <a href="{{ route('offpartsearch') }}" class="btn btn-secondary">Reset</a>
                    </form>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($inventoryItems as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('offinventory/add/new') }}">
                                            <span class="badge bg-info"><i class="bi bi-person-plus-fill"></i></span>
                                        </a>
                                        <a href="{{ url('offpartsearch/detail/'.$item->id) }}">
                                            <span class="badge bg-success"><i class="bi bi-pencil-square"></i></span>
                                        </a>  
                                        <a href="{{ url('delete_offinventory/'.$item->id) }}" onclick="return confirm('Are you sure to want to delete it?')"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
