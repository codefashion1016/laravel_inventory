    ...
    <div class="page-heading">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('offorders') }}">Offorders</a></li>
        ...
        <div class="col-lg-12 col-12">
            <div id="auth-left">
                ...
                <form method="POST" action="{{ route('offpull_request') }}" class="md-float-material" enctype="multipart/form-data">
                    @csrf
