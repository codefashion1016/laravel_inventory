            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h1>Offshore Inventory</h1>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('inventoryoffshore') }}">Offshore Inventory</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Offshore Inventory Mangement</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ url('/offinventory/' . $category) }}">{{ $category }}</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
