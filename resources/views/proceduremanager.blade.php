...
<?php else: ?>
    ...
    @push('styles')
        <style>
            ...
            ul.list-unstyled.fm-tree-branch > li:first-child {
                display: none !important;
            }
            .fm-table table.table-sm tbody tr:first-child {
                display: none !important;
            }
    ...
    <script>
        window.onload = function(){
            ...
            if (currentUrl.includes('/filemanager')) {
