                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="password" class="form-control" name="email" value="{{ Auth::user()->password }}" readonly>
                                                            <div class="form-control-icon">
                                                                <i class="bi bi-key"></i>
                                                            </div>
                                                        </div>
        ...
        <div class="page-content">
            <section class="row">
                <div class="col-12 col-lg-12">
                    <div class="card" data-bs-toggle="modal" data-bs-target="#default" style="float:right">
                        <div class="card-body py-4 px-5">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-xl">
                                    <img src="{{ URL::to('/images/'. Auth::user()->avatar) }}" alt="{{ Auth::user()->avatar }}">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="password" class="form-control" name="email" value="{{ Auth::user()->password }}">
                                                            <div class="form-control-icon">
                                                                <i class="bi bi-key"></i>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('inventorydrs') }}">Inventory Systems</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('filemanager') }}">Procedures</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('trainmanager') }}">Training</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:center">
                                            <h4 class="text-muted font-semibold"><a href="{{ route('drawingmanager') }}">Drawings</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
